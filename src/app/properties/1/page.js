...
const images = Array.from({ length: 37 }, (_, i) => `/property_1/${i + 1}.jpg`);
    ...
    <div data-aos="fade-up">
      ...
      <div className="flex flex-row justify-between items-center px-6 md:px-16 lg:px-32">
        ...
        <Link
          ...
          href={
            "https://www.airbnb.com/rooms/1145666172569037981?guests=1&adults=1&s=67&unique_share_id=3008a92c-b0e5-4eae-ae6b-fcd427f1ceb4&source_impression_id=p3_1741180345_P3NmH38OMrNX9MEO"
          }
          target="_blank"
        >
          ...
          <div className="flex justify-center">
            <div className="relative w-full">
              <iframe
                ...
                frameBorder="0"
                src="https://booking.hospitable.com/widget/9c44107d-5e61-4158-83cd-ba3beee8b278/1435114"
              ></iframe>
            </div>
          </div>
        </div>
